...
```
sources_1/new/cpm_pcie_qdma_ep_wrapper.sv                         [SV] Top-level QDMA endpoint wrapper
│
├── sources_1/bd/cpm_pcie/cpm_pcie.bd                             [BD] PCIe / NoC / HBM top block design
...
│
├── sources_1/imports/exdes/qdma_app.sv                           [SV] QDMA application layer
...
│
├── imports/imports/cm3_system/cm3_system.sv                      [SV] Cortex-M3 control subsystem
...
│   └── cm3_system/cm3_system_cdc_top.v                          [V]  Clock-domain crossing
│
├── imports/imports/bus_matrix/bus_matrix.v                       [V]  AHB bus matrix
